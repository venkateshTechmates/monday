                    ...
                    <div className="section2-main">
                        ...
                        <div className="section3">
                            ...
                            <div className="products">
                                <svg viewBox="0 0 16 17" fill="currentColor" width="32" height="32" aria-hidden="true"
                                    className="icon_component">
                                    <g fill="currentColor" clip-path="url(#clip0_1898_40324)">
                                        <path
                                    ...
                                    <defs>
                                        <clipPath id="clip0_1898_40324">
                                            <path fill="#fff" transform="translate(.211 .974)" d="M0 0H15.053V15.053H0z"></path>
                                        </clipPath>
                                    </defs>
                                </svg>
                            </div>
                            <div className="profile-img">
                                <img src="https://cdn1.monday.com/dapulse_default_photo.png"
                                    className="person-bullet-image person-bullet-component" title="Bluescreen Studios"
                                    alt="Bluescreen Studios" aria-hidden="true" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="work-space">
                    <div className="work-space-layout">
                        <div className="work-space-heading">
                            <span className="work-space-heading-text">
                                Workspace
                            </span>
                        ...
                        <div className="work-space-select">
                            <div className="sub">
                                <div className="workspace-icon icon" role="img" aria-label="Workspace">
                                    <span className="letter">M</span>
                                    <span className="heading" style={{ marginLeft: "10px" }}>Main workspace</span>
                                </div>
                        ...
                        <div className="btn-work work-space-add">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div className="btn-work work-space-search">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div className="work-space-spliter">
                            <span></span>
                        </div>
                        <div className="work-space-main">
                            <div className="list1">
                                <div style={{ marginBottom: "3px", marginRight: "4px" }}><span><svg viewBox="0 0 20 20"
                                    fill="currentColor" width="19" height="19" aria-hidden="true"
                                    aria-label="Public board" className="icon_component">
                                    <path
                                ...
                                <div><span>Bluescreen Vfx</span></div>
                            </div>
                        </div>
                    </div>
